            ...
            <section className={styles.startInfo}>
                ...
                <div className={styles.startWrapper}>
                    <div className={styles.startTitle}>
                        Ежегодно Екатеринбург теряет сотни взрослых деревьев. Защитим их вместе!
                    </div>
            ...
            <section className={styles.volunteers}>
                ...
                <div className={styles.voluntaryWrapper}>
                    ...
                    <p className={styles.voluntaryText}>
                        Мы - группа неравнодушных горожан Екатеринбурга. Уже более трех лет мы добиваемся соблюдения права жителей на зеленый город.
                        Нас много и мы разные, в нашей команде есть архитекторы, экологи, it-специалисты, градостроители, дендрологи и многие другие.
                    </p>
                    <p className={styles.voluntaryText}>
        ...
        return (
            <section className={styles.weDoBlock}>
                <div className={styles.innerSection2}>
                    <header className={styles.weDoHeader}>Что мы делаем ?</header>
                    <div className={styles.weDoInner}>
                        <p className={styles.weDoContent}>Мы заботимся о деревьях в городе.
                            ...
                            Когда озеленение - это деревья, то каждое дерево важно и ценно.
                        </p>
